...
const MyEquipmentList = () => {
  ...
  useEffect(() => {
    const fetchUserEquipment = async () => {
      setIsLoading(true)
      try {
        const response = await fetch(`https://b10-a10-server-side-roan.vercel.app/equipment/user/${currentUser.email}`)
  ...
  return (
    <div className="p-6 bg-gray-100 dark:bg-gray-900">
      ...
      {isLoading ? (
        ...
        <>
          <h2 className="text-3xl font-bold mb-6 text-center dark:text-gray-100">My Equipment List</h2>
