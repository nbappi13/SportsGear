  ...
  return (
    <div className="p-6 bg-gray-100 dark:bg-gray-900">
      ...
      {isLoading ? (
        ...
        <div>
          <h2 className="text-4xl font-bold mb-6 text-center dark:text-gray-100">All Sports Equipment</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {equipment.map((item) => (
              ...
              >
                ...
                />
                <h3 className="font-semibold text-lg dark:text-gray-100">{item.itemName}</h3>
