      ...
      {cartItems.length === 0 ? (
        ...
        <div className="space-y-6">
          {cartItems.map((item, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-gray-100 shadow-md p-4 rounded-lg flex flex-col sm:flex-row items-center justify-between relative"
            >
              <div className="flex items-center">
                ...
                <img
                  ...
                  alt={item.itemName}
                  className="w-24 h-24 object-cover rounded-lg shadow-lg mb-4 sm:mb-0"
                />
              </div>
              ...
              <div className="flex flex-col items-end">
                ...
                <button className="text-red-500 hover:text-red-600" onClick={() => removeFromCart(index)}>
                  <CgClose size={24} />
                </button>
              </div>
            </div>
