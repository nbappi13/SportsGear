...
const SpecialDeals = () => {
  ...
  // Fetch special deals data when component loads
  useEffect(() => {
    setIsLoading(true)
    ...
    fetch("https://b10-a10-server-side-roan.vercel.app/special-deals ")
      ...
      .catch((error) => {
        ...
        if (localDeals.length > 0) {
          ...
          // Create fake deals from regular equipment if no local deals
